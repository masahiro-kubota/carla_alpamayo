...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--train-config-dir", default=str(PROJECT_ROOT / "data_collection" / "configs" / "routes" / "town01_movement_train"))
    parser.add_argument("--eval-config-dir", default=str(PROJECT_ROOT / "data_collection" / "configs" / "routes" / "town01_movement_eval"))
    return parser
