...
_EXPLORATORY_DOCS: tuple[ScenarioDocSeed, ...] = (
    ScenarioDocSeed(
        name="blocked_static_near",
        title="Blocked Static Near Scenario",
        group="exploratory",
        summary="same-lane の停止障害物が近距離にあり、反対車線の static blocker も効いているため、安全に減速停止することを確認する scenario です。",
        contract=(
        ...
        planned_run_config_name="town01_stopped_obstacle_blocked_near_long_expert.json",
    ),
    ScenarioDocSeed(
