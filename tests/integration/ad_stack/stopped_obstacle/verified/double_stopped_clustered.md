...
- summary:
  - `outputs/evaluate/20260329_072812_town01_northbound_overtake_long_expert_eval_f60bc2624ab7/summary.json`
- manifest:
  - `outputs/evaluate/20260329_072812_town01_northbound_overtake_long_expert_eval_f60bc2624ab7/manifest.jsonl`
...
- `PASS`
- manifest 上で `overtake_target_kind=cluster`
- `overtake_target_member_actor_ids=[213, 214]`
- 1 回の `lane_change_out -> pass_vehicle -> lane_change_back` で cluster 全体を追い越す
- `collision_count=0`, `overtake_attempt_count=1`, `overtake_success_count=1`
