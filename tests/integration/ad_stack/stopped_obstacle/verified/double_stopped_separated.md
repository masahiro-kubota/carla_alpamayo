...
- summary:
  - `outputs/evaluate/20260329_072739_town01_northbound_overtake_long_expert_eval_f60bc2624ab7/summary.json`
- manifest:
  - `outputs/evaluate/20260329_072739_town01_northbound_overtake_long_expert_eval_f60bc2624ab7/manifest.jsonl`
...
- まず 1 台目を `follow_target_id` / `overtake_target_actor_id` として見る
...
- 1 台目通過後に `follow_target_id` または `overtake_target_actor_id` が 2 台目へ切り替わる
- actor 切替の前後で state 遷移が説明可能

## Verification Verdict

- `PASS`
- `overtake_target_actor_id` は `207 -> 208` に切り替わる
- 2 回の `lane_change_out -> pass_vehicle -> lane_change_back` が manifest 上で確認できる
- `collision_count=0`, `overtake_attempt_count=2`, `overtake_success_count=2`
