...
class OvertakeSceneAssemblerTests(unittest.TestCase):
    def test_stopped_lead_matches_lead_speed_for_follow_target(self) -> None:
        tracked_objects = (
            SimpleNamespace(
                actor_id=101,
                relation="same_lane",
        ...
        self.assertEqual(snapshot.follow_target_speed_kmh, 0.0)

    def test_moving_lead_matches_lead_speed_for_follow_target(self) -> None:
        tracked_objects = (
            SimpleNamespace(
                actor_id=101,
                relation="same_lane",
        ...
        self.assertAlmostEqual(snapshot.follow_target_speed_kmh, 10.0)
