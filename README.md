...
```bash
cd /media/masa/ssd_data/carla_alpamayo
./scripts/run_collect_town01_junction_pack.sh
```
...
- `front RGB + speed + command + target-point -> steer` に変え、high-curvature `lanefollow` pack を追加収集した
- 最終評価では [summary.json](/home/masa/carla_alpamayo/outputs/evaluate/town01_pilotnet_loop_pilotnet_eval_20260321_075722/summary.json) の `success = true`, `route_completion_ratio = 0.9991`, `collision_count = 0`
- learned lateral policy の完走動画は [front_rgb.mp4](/home/masa/carla_alpamayo/outputs/evaluate/town01_pilotnet_loop_pilotnet_eval_20260321_075722/front_rgb.mp4)
